...
var total = document.querySelectorAll("[navigation-pills]");

total.forEach(function (item, i) {
  var moving_div = document.createElement("div");
  var first_li = item.querySelector("li:first-child [navigation-link]");
  ...
  moving_div.setAttribute("navigation-link", "");
  ...
  item.onmouseover = function (event) {
    ...
    if (li) {
      ...
      item.querySelector("li:nth-child(" + index + ") [navigation-link]").onclick = function () {
...
window.addEventListener("resize", function (event) {
  total.forEach(function (item, i) {
    ...
    var moving_div = document.createElement("div");
    var tab = item.querySelector("[navigation-link][active]").cloneNode();
    tab.innerHTML = "-";
    tab.classList.remove("bg-inherit");
    tab.classList.add("bg-white", "text-white", "shadow-soft-xxs");
    tab.style.animation = ".2s ease";
    ...
    let li = item.querySelector("[navigation-link][active]").parentElement;
