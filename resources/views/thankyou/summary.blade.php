        ...
        <div class="flex flex-col justify-center h-full">
            ...
            <div class="w-full max-w-2xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                <header class="px-5 py-4 border-b border-gray-100">
                    ...
                    <h4 class="font-semibold text-gray-800">Order total: <strong>{{ $order->total }}$</strong></h4>
                </header>
                <div class="p-3">
            ...
            <a href="{{route('home')}}"
                      class="text-center mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium w-25 text-blue-50 hover:bg-blue-600">
